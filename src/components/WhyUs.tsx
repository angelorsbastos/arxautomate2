      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-16  reveal">
          {[
            ...
            <div
              key={index}
              className={`feature-card text-center  p-6 rounded-2xl shadow-xl  border-white/10 backdrop-blur-lg bg-white/5 ${isDark ? 'bg-gradient-to-br' : 'bg-gray-50'
                }`}
            >

              <div className="text-3xl md:text-4xl font-bold mb-2">
                <span
                  className={`${isDark ? 'text-white-700' : 'text-gray-700'
                    }`}
                >
                  {stat.value}
                </span>
