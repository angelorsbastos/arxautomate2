...
const Hero = () => {
  ...
  return (
    <header
      id="hero"
      className={`relative min-h-screen overflow-hidden flex items-center justify-center ${isDark ? 'bg-black' : 'bg-white'
        }`}
    >
      {/* Theme toggle */}
      ...
      <div className="absolute top-5 left-5 z-50 flex items-center gap-2 max-w-[calc(100vw-200px)] xl:max-w-none">
        ...
        <h1
          className={`hidden xl:block text-xl 2xl:text-2xl tracking-[5px] font-normal whitespace-nowrap ${isDark ? 'text-white' : 'text-gray-900'
            }`}
      ...
      <div className="relative z-10 w-full max-w-4xl px-6 text-center">
        <div className="bg-white/5 border border-white/10 backdrop-blur-lg rounded-3xl p-6 sm:p-8 md:p-10 shadow-2xl animate-fade-in-up">
          ...
          <div
            className={`hidden sm:block xl:hidden mb-6 text-2xl md:text-3xl tracking-[6px] ${isDark ? 'text-white' : 'text-gray-900'
              }`}
            style={{ fontFamily: 'Mokoto' }}
          >
            <span>AR</span>
          ...
          <div
            className={`sm:hidden mb-4 text-2xl tracking-[5px] ${isDark ? 'text-white' : 'text-gray-900'
              } font-mokoto`}
          >
            <span>AR</span>
          ...
          <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight ${isDark ? 'text-white' : 'text-gray-900'}`}>
          ...
          <p className={`mt-6 text-base sm:text-lg md:text-xl font-light ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <button
              ...
              className={`group relative px-6 sm:px-8 py-3 sm:py-4 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform hover:scale-105 border-2 ${isDark
            ...
            >
              ...
              <span className={`absolute inset-0 rounded-full opacity-0 group-hover:opacity-30 transition duration-300 blur-lg ${isDark ? 'bg-white/30' : 'bg-gray-900/30'
                }`} />
            </button>
